...
class TextWindow(PopupWindow):
    ...
    def _refresh(self):
        ...
        bui.buttonwidget(edit=self._backButton, button_type='backSmall',size=(60, 60),label=babase.charstr(babase.SpecialChar.BACK))
            ...
            if self.texts_widgets == {}:
                ...
                if cfg['Multicolor']:
                    with babase.ContextRef.empty():
                           self.text_time = bs.Timer(0.1, babase.CallPartial(self.text_update_color), repeat=True)
                else: pass
